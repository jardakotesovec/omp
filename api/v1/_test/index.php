...
// /scenarios/context (canonical, cross-app) and its OMP alias
// /scenarios/press build a scratch (or baseline) context;
...
foreach (['/_test/scenarios/context', '/_test/scenarios/press'] as $contextRoute) {
    if (strpos($requestPath, $contextRoute) !== false) {
        return new \PKP\handler\APIHandler(new \APP\API\v1\_test\PressScenarioController());
    }
}
