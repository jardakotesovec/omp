 ...
 *
 * @class OMPTestInstallTool
 *
 * @ingroup tools
 *
 * @brief Non-interactive OMP install for the Playwright test harness.
 *
...
class OMPTestInstallTool extends \PKP\cliTool\InstallTool
{
...
$tool = new OMPTestInstallTool($argv ?? []);
$tool->execute();
